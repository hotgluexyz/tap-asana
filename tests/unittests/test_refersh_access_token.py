...
class TestRefreshAccessToken(unittest.TestCase):
    def test_invalid_token_error_for_get_initial(
    ...
    def test_no_authorized_error_for_get_initial(
        self, mocked_sleep, mocked_get, mocked_refresh_access_token
    ):
        """
    ...
    def test_token_expired_error_for_get_initial(
        self, mocked_sleep, mocked_get, mocked_refresh_access_token
    ):
        """
    ...
    def test_no_error_for_get_initial(
        self, mocked_sleep, mocked_get, mocked_refresh_access_token
    ):
        """
    ...
    def test_invalid_token_error_for_get_next(
        self, mocked_sleep, mocked_get, mocked_refresh_access_token
    ):
        """
    ...
    def test_no_authorized_error_for_get_next(
        self, mocked_sleep, mocked_get, mocked_refresh_access_token
    ):
        """
    ...
    def test_token_expired_error_for_get_next(
        self, mocked_sleep, mocked_get, mocked_refresh_access_token
    ):
        """
    ...
    def test_no_error_for_get_next(
        self, mocked_sleep, mocked_get, mocked_refresh_access_token
    ):
        """
        Verify that refresh_access_token is called one time for Asana initialization and
