...
class TestTimeoutErrorBase(unittest.TestCase):
    def test_timeout_value_not_in_config__Base(
        self, mocked_sleep, mocked_get_attr, mocked_refresh_access_token
    ):
    ...
    def test_timeout_value_in_config__Base(
        self, mocked_sleep, mocked_get_attr, mocked_refresh_access_token
    ):
        # Set asana client in Context before test
        Context.asana = Asana("test", "test", "test", "test", "test")
    ...
    def test_timeout_string_value_in_config__Base(
        self, mocked_sleep, mocked_get_attr, mocked_refresh_access_token
    ):
        # Set asana client in Context before test
        Context.asana = Asana("test", "test", "test", "test", "test")
    ...
    def test_timeout_empty_value_in_config__Base(
        self, mocked_sleep, mocked_get_attr, mocked_refresh_access_token
    ):
        # Set asana client in Context before test
        Context.asana = Asana("test", "test", "test", "test", "test")
    ...
    def test_timeout_0_value_in_config__Base(
        self, mocked_sleep, mocked_get_attr, mocked_refresh_access_token
    ):
        # Set asana client in Context before test
        Context.asana = Asana("test", "test", "test", "test", "test")
    ...
    def test_timeout_string_0_value_in_config__Base(
        self, mocked_sleep, mocked_get_attr, mocked_refresh_access_token
    ):
        # Set asana client in Context before test
        Context.asana = Asana("test", "test", "test", "test", "test")
...
class TestTimeoutValuesSections(unittest.TestCase):
    ...
    def test_zero_string_request_timeout_in_config(self):
        ...
        projects = list(Sections().get_objects())
...
class TestRequestTimeoutBackoff(unittest.TestCase):
    def test_timeout_error_for_get_initial(
        self, mocked_sleep, mocked_get, mocked_refresh_access_token
    ):
        """
    ...
    def test_timeout_error_for_get_next(
        self, mocked_sleep, mocked_get, mocked_refresh_access_token
    ):
        """
